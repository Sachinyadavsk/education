...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "e558fd8c-eef4-4b42-8afc-229c70002821");
    ...
    return (
        <div className="contact">
            <div className="contact-col">
                ...
                <ul>
                    <li><img src={mail_icon} alt="" />Contact@sachinskym</li>
                    <li><img src={phone_icon} alt="" />+1 963-852-741</li>
                    <li><img src={location_icon} alt="" />Education India institute technology bharat</li>
                </ul>
            </div>
            <div className="contact-col">
